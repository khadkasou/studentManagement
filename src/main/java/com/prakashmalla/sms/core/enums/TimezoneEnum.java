...
public enum TimezoneEnum {
    ...
    AUSTRALIA_BRISBANE("Australia/Brisb ane"),
    ...
    public static TimezoneEnum fromName(String name) {
        for (TimezoneEnum tz : TimezoneEnum.values()) {
            if (tz.getTimezone().equalsIgnoreCase(name)) {
                return tz;
            }
        }
        throw new IllegalArgumentException("Unknown timezone name: " + name);
    }
}
